 ...
 *
 * `@fourjs/assets` parses a glTF file into plain validated data (its `gltf.ts`
 ...
 * `@fourjs/math` is visible; the parse tier already refused non-finite
...
import type { GltfAsset } from "@fourjs/assets";
import {
  AnimationClip,
  AnimationTrack,
  quaternionAdapter,

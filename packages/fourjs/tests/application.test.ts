...
import { AssetManager } from "@fourjs/assets";
 ...
 * (the real counting is `@fourjs/render-webgl`'s own test).
 */
 ...
 *
 * A real `PhysicsWorld` needs a `PhysicsSolverAdapter`, and `@fourjs/physics`'

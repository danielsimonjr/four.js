 ...
 * happened to {@link DEFAULT_GRAVITY_Y} (`@fourjs/physics` for world gravity,
 * `@fourjs/particles` for the default gravity field, no §3.1 edge between them,
 ...
 * Used by `@fourjs/physics` as the default world gravity and by
 * `@fourjs/particles` as the default acceleration of `uniformGravityField`.
 */

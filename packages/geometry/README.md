...
2D shape primitives, the path model (Bézier, arcs, Boolean ops), tessellation and stroke generation (an isolated, replaceable tessellator per §52), 3D primitives, and buffer/indexed/procedural geometry.

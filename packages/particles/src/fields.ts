 ...
 * | GPU field               | **partial** — `radialField` ships on `simulation: "gpu"` (`gpuField` brand, `resolveGpuRadial` in `emitter.ts`, R-31 2026-08-29). Vortex, wind, drag, turbulence, and callback GPU fields remain staged |
...
import { DEFAULT_GRAVITY_Y } from "@fourjs/core";
 ...
 *
 * `@fourjs/core`'s constant, re-exported (hoisted 2026-08-04; it was duplicated
 * from `@fourjs/physics` while §3.1's missing edge left nothing shared to
 * import).
 */

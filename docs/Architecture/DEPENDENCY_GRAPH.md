...
3. [Packages/render webgpu Dependencies](#packages-render-webgpu-dependencies)
4. [Packages/text Dependencies](#packages-text-dependencies)
5. [Packages/math Dependencies](#packages-math-dependencies)
6. [Packages/ui Dependencies](#packages-ui-dependencies)
7. [Packages/serialization Dependencies](#packages-serialization-dependencies)
8. [Packages/render webgl Dependencies](#packages-render-webgl-dependencies)
9. [Packages/physics box2d Dependencies](#packages-physics-box2d-dependencies)
10. [Packages/core Dependencies](#packages-core-dependencies)
11. [Packages/scene Dependencies](#packages-scene-dependencies)
12. [Packages/assets Dependencies](#packages-assets-dependencies)
13. [Packages/four Dependencies](#packages-four-dependencies)
14. [Packages/render Dependencies](#packages-render-dependencies)
...
17. [Packages/materials Dependencies](#packages-materials-dependencies)
18. [Packages/render canvas Dependencies](#packages-render-canvas-dependencies)
19. [Packages/particles Dependencies](#packages-particles-dependencies)
20. [Packages/diagnostics Dependencies](#packages-diagnostics-dependencies)
21. [Packages/physics soft Dependencies](#packages-physics-soft-dependencies)
22. [Packages/input Dependencies](#packages-input-dependencies)
23. [Packages/animation Dependencies](#packages-animation-dependencies)
24. [Packages/render svg Dependencies](#packages-render-svg-dependencies)
25. [Packages/motion Dependencies](#packages-motion-dependencies)
26. [Packages/physics rapier Dependencies](#packages-physics-rapier-dependencies)
...
| `@four/ui` (`packages/ui/`) | `@four/math`, `@four/input`, `@four/scene`, `@four/core`, `@four/text` | 13 | 0 |
| `@four/serialization` (`packages/serialization/`) | `@four/core`, `@four/math`, `@four/scene` | 5 | 0 |
...
| `@four/scene` (`packages/scene/`) | `@four/core`, `@four/math` | 16 | 0 |
| `@four/assets` (`packages/assets/`) | `@four/core` | 7 | 0 |
| `four` (`packages/four/`) | `@four/materials`, `@four/motion`, `@four/physics`, `@four/render`, `@four/serialization`, `@four/scene`, `@four/render-webgl`, `@four/geometry`, `@four/text`, `@four/core`, `@four/assets`, `@four/ui`, `@four/render-svg`, `@four/particles`, `@four/physics-soft`, `@four/animation`, `@four/math`, `@four/input`, `@four/physics-rapier`, `@four/diagnostics`, `@four/physics-box2d`, `@four/render-webgpu`, `@four/render-canvas` | 33 | 0 |
| `@four/render` (`packages/render/`) | `@four/core`, `@four/materials`, `@four/scene`, `@four/math`, `@four/geometry` | 27 | 0 |
| `@four/physics` (`packages/physics/`) | `@four/core`, `@four/math`, `@four/motion`, `@four/scene` | 22 | 0 |
| `@four/geometry` (`packages/geometry/`) | `@four/core`, `@four/math` | 10 | 0 |
| `@four/materials` (`packages/materials/`) | `@four/math`, `@four/core` | 12 | 0 |
| `@four/render-canvas` (`packages/render-canvas/`) | (none) | 1 | 0 |
| `@four/particles` (`packages/particles/`) | `@four/math`, `@four/scene`, `@four/core` | 9 | 0 |
| `@four/diagnostics` (`packages/diagnostics/`) | `@four/core`, `@four/math` | 11 | 0 |
| `@four/physics-soft` (`packages/physics-soft/`) | (none) | 1 | 0 |
| `@four/input` (`packages/input/`) | `@four/scene`, `@four/core`, `@four/math` | 8 | 0 |
| `@four/animation` (`packages/animation/`) | `@four/math`, `@four/core`, `@four/scene`, `@four/motion` | 11 | 0 |
| `@four/render-svg` (`packages/render-svg/`) | (none) | 1 | 0 |
| `@four/motion` (`packages/motion/`) | `@four/math`, `@four/core`, `@four/scene` | 20 | 0 |
| `@four/physics-rapier` (`packages/physics-rapier/`) | `@four/core`, `@four/math`, `@four/physics` | 8 | 0 |

### Package Dependency Diagram

```mermaid
graph LR
    P0[packages/render-webgpu]
    P1[packages/text]
    P2[packages/math]
    P3[packages/ui]
    P4[packages/serialization]
    P5[packages/render-webgl]
    ...
    P14[packages/materials]
    P15[packages/render-canvas]
    P16[packages/particles]
    P17[packages/diagnostics]
    P18[packages/physics-soft]
    P19[packages/input]
    P20[packages/animation]
    P21[packages/render-svg]
    P22[packages/motion]
    P23[packages/physics-rapier]
    P0 --> P11
    P0 --> P7
    P0 --> P2
    P0 --> P8
...
| `./gl-particles.js` | `PARTICLE_ATTRIBUTE_LOCATIONS, PARTICLE_GL, ParticleBatchCache, ParticleProgram, ParticleTrailBatchCache, ParticleTrailProgram` | Re-export |
| `./gl-program.js` | `COLOR_ATTRIBUTE_LOCATION, GL, LitProgram, MAP_TEXTURE_UNIT, METAL_ROUGHNESS_TEXTURE_UNIT, NORMAL_ATTRIBUTE_LOCATION, POSITION_ATTRIBUTE_LOCATION, PUNCTUAL_LIGHT_GLSL, PunctualLightUniforms, SHADOW_GLSL, SHADOW_TEXTURE_UNIT, ShadowUniforms, SpriteProgram, UV_ATTRIBUTE_LOCATION, UnlitProgram` | Re-export |
...
| `@four/core` | `Disposable` |
| `@four/math` | `Matrix4` |
| `@four/render` | `PARTICLE_COLOR_OFFSET, PARTICLE_INSTANCE_FLOATS, PARTICLE_POSITION_OFFSET, PARTICLE_SIZE_OFFSET, TRAIL_COLOR_OFFSET, TRAIL_POSITION_OFFSET, TRAIL_VERTEX_FLOATS, ParticleRenderItem` |
...
**Exports:**
- Classes: `ParticleProgram`, `ParticleBatchCache`, `ParticleTrailProgram`, `ParticleTrailBatchCache`
...
| `./gl-particles.js` | `ParticleBatchCache, ParticleProgram, ParticleTrailBatchCache, ParticleTrailProgram, ParticleGlContext` | Import |
| `./gl-program.js` | `GL, LitProgram, MAP_TEXTURE_UNIT, METAL_ROUGHNESS_TEXTURE_UNIT, SHADOW_TEXTURE_UNIT, SpriteProgram, UnlitProgram, GlTexture` | Import |
...
| File | Imports | Type |
|------|---------|------|
| `./gl-program.js` | `MAP_TEXTURE_UNIT, METAL_ROUGHNESS_TEXTURE_UNIT, PUNCTUAL_LIGHT_GLSL, PunctualLightUniforms, SHADOW_GLSL, ShadowUniforms, createLinkedProgram, matrixScratch, requireUniform, GlProgramHandle, GlUniformLocation, WebglContext` | Import |
...
### `packages/scene/src/index.ts` - Package entry point for @four/scene (re-exports 79 symbols)
...
| `@four/render` | `RENDERER_REGISTRY, RENDER_GRAPH` |
| `@four/serialization` | `COMPONENT_SERIALIZERS, SCENE_MIGRATIONS` |

**Exports:**
- Re-exports: `SIMULATION_SYSTEMS`, `SOLVER_REGISTRY`, `RENDERER_REGISTRY`, `RENDER_GRAPH`, `COMPONENT_SERIALIZERS`, `SCENE_MIGRATIONS`
...
| `@four/scene` | `Bone, DirectionalLight, MORPH_WEIGHTS_SERIALIZER, MorphWeights, OrthographicCamera, PerspectiveCamera, PointLight, SCREEN_ORIGINS, SCREEN_UNITS, ScreenCamera, SpotLight, restoreNodeId, HitTestMode, Node` |
...
### `packages/four/src/live-resource-counts.ts` - live-resource-counts module
...
| `@four/physics` | `liveSolverBodyCount` |
...
| `@four/diagnostics` | `beginFrameAllocationCheck, createFrameStats, endFrameAllocationCheck, monotonicNowSeconds, recordRenderStatistics, recordResourceMemory, recordSolverStatistics, resetFrameStats, solverStatistics, FrameStats, SolverStatistics` |
...
**Exports:**
- Constants: `RENDERER_REGISTRY`, `RENDER_GRAPH`
...
- Interfaces: `RenderTargetOptions`, `RenderTargetTexture`, `RenderTargetByteLengthOptions`
- Types: `RenderTargetFormat`
- Functions: `isRenderTargetTexture`, `validateColorSpace`, `colorAttachmentBytesPerTexel`, `depthAttachmentBytesPerTexel`, `renderTargetBytesPerTexel`
...
- Constants: `PARTICLE_INSTANCE_FLOATS`, `PARTICLE_POSITION_OFFSET`, `PARTICLE_SIZE_OFFSET`, `PARTICLE_COLOR_OFFSET`, `TRAIL_VERTEX_FLOATS`, `TRAIL_POSITION_OFFSET`, `TRAIL_COLOR_OFFSET`
...
| `./capabilities.js` | `RENDERER_REGISTRY, RENDER_GRAPH` | Re-export |
...
| `./particles.js` | `PARTICLE_COLOR_OFFSET, PARTICLE_INSTANCE_FLOATS, PARTICLE_POSITION_OFFSET, PARTICLE_SIZE_OFFSET, TRAIL_COLOR_OFFSET, TRAIL_POSITION_OFFSET, TRAIL_VERTEX_FLOATS, isParticleDrawable, particleQuadGeometry` | Re-export |
...
| `./render-target.js` | `RenderTarget, colorAttachmentBytesPerTexel, depthAttachmentBytesPerTexel, isRenderTargetTexture, renderTargetBytesPerTexel` | Re-export |
...
| `./render-target.js` | `RenderTargetByteLengthOptions, RenderTargetFormat, RenderTargetOptions, RenderTargetTexture` | Re-export (type-only) |
...
| `./shape.js` | `ArcOptions, CircleOptions, EllipseOptions, GradientStop, LinearGradientPaint, LineOptions, ObjectPaint, Paint, PathShapeOptions, PatternPaint, PolygonOptions, PolylineOptions, RadialGradientPaint, RectangleOptions, RegularPolygonOptions, RingOptions, SectorOptions, ResolvedGradientStop, ResolvedLinearGradientPaint, ResolvedObjectPaint, ResolvedPaint, ResolvedPatternPaint, ResolvedRadialGradientPaint, ResolvedShapeFill, ResolvedSolidPaint, ResolvedStrokeStyle, Shape2DOptions, ShapeFill, ShapePaintPlan, ShapePaintSupport, SolidPaint, StarOptions, StrokeStyle` | Re-export (type-only) |
...
- Interfaces: `SolidPaint`, `GradientStop`, `LinearGradientPaint`, `RadialGradientPaint`, `PatternPaint`, `ResolvedSolidPaint`, `ResolvedGradientStop`, `ResolvedLinearGradientPaint`, `ResolvedRadialGradientPaint`, `ResolvedPatternPaint`, `StrokeStyle`, `ResolvedStrokeStyle`, `ShapePaintPlan`, `ShapePaintSupport`, `Shape2DOptions`, `CircleOptions`, `EllipseOptions`, `RectangleOptions`, `RegularPolygonOptions`, `StarOptions`, `SectorOptions`, `RingOptions`, `PolygonOptions`, `PathShapeOptions`, `LineOptions`, `PolylineOptions`, `ArcOptions`
...
| File | Imports | Type |
|------|---------|------|
| `./shape.js` | `setShapePaintSupport, GradientStop, LinearGradientPaint, Paint, PatternPaint, RadialGradientPaint, ResolvedGradientStop, ResolvedLinearGradientPaint, ResolvedObjectPaint, ResolvedPaint, ResolvedPatternPaint, ResolvedRadialGradientPaint, ResolvedShapeFill, ResolvedStrokeStyle, ShapePaintPlan` | Import |
...
| `./resource-memory.js` | `liveSolverBodyCount` | Re-export |
...
| `./resource-memory.js` | `noteSolverBody` | Import |
...
### `packages/physics/src/resource-memory.ts` - resource-memory module

**Exports:**
- Functions: `noteSolverBody`, `liveSolverBodyCount`
...
### `packages/materials/src/index.ts` - Package entry point for @four/materials (re-exports 50 symbols)
...
| File | Imports | Type |
|------|---------|------|
| `./resource-memory.js` | `noteMaterial` | Import |
...
### `packages/materials/src/resource-memory.ts` - resource-memory module

**Exports:**
- Functions: `noteMaterial`, `liveMaterialCount`
...
- Constants: `PARTICLE_INSTANCE_FLOATS`, `PARTICLE_TRAIL_VERTEX_FLOATS`
...
**Exports:**
- Interfaces: `ParticleForceField`, `ParticleGpuSimulation`, `ParticleRange`, `ParticleLifetimeStop`, `ParticleLifetimeRamp`, `ParticleColor`, `ParticleBurst`
...
| `./particle-renderable.js` | `PARTICLE_INSTANCE_FLOATS, PARTICLE_TRAIL_VERTEX_FLOATS, ParticleRenderable` | Re-export |
...
| `./types.js` | `ParticleBurst, ParticleColor, ParticleForceField, ParticleGpuSimulation, ParticleLifetimeRamp, ParticleLifetimeStop, ParticleRange, ParticleSimulationMode` | Import (type-only) |
...
### `packages/diagnostics/src/dev-warnings.ts` - §83's development warnings (A-5 remainder, 2026-09-06).
...
**Exports:**
- Functions: `warnDisposedResourceInUse`, `warnDetachedNodeListeners`, `warnStalePhysicsHandle`, `warnPerFrameAllocations`, `beginFrameAllocationCheck`, `endFrameAllocationCheck`
- Constants: `DEFAULT_PER_FRAME_ALLOCATION_THRESHOLD`
...
| `./validation.js` | `COORDINATE_ENVELOPE, NEAR_ZERO_SCALE, UNSTABLE_SCALE_RATIO, assertFinite, assertNoSceneGraphCycle, validateSceneNode, validateSceneSubtree, warnCoordinateEnvelope, warnSingularScale, warnUnstableScale` | Re-export |
| `./dev-warnings.js` | `DEFAULT_PER_FRAME_ALLOCATION_THRESHOLD, beginFrameAllocationCheck, endFrameAllocationCheck, warnDetachedNodeListeners, warnDisposedResourceInUse, warnPerFrameAllocations, warnStalePhysicsHandle` | Re-export |
...
**Exports:**
- Constants: `PACKAGE_NAME`
- Re-exports: `createChecksum`, `hashFloats`, `ReplayRecorder`, `RollbackBuffer`, `LATEST_REPLAY_FORMAT_VERSION`, `MINIMUM_REPLAY_FORMAT_VERSION`, `REPLAY_FORMAT_VERSION`, `SUPPORTED_REPLAY_FORMAT_VERSIONS`, `assertReplayCompatible`, `cloneJsonValue`, `decodeBase64`, `decodeReplayRecording`, `encodeBase64`, `encodeReplayRecording`, `isReplayCompatible`, `validateReplayRecording`, `DEFAULT_REPLAY_MAXIMUM_SUB_STEPS`, `ReplayPlayer`, `DEBUG_COLOR_FLOATS_PER_SEGMENT`, `DEBUG_DRAW_DEFAULT_COLORS`, `DEBUG_DRAW_STAGED`, `DEBUG_POSITION_FLOATS_PER_SEGMENT`, `DEBUG_SEGMENT_FLOATS`, `DEBUG_VERTEX_FLOATS`, `DEFAULT_DEBUG_BUFFER_CAPACITY`, `DebugDrawBuffer`, `applyDebugDrawStreams`, `collectBodyOrigins`, `collectBodyVelocities`, `collectCentersOfMass`, `collectContactImpulses`, `collectContactPoints`, `debugDrawStreams`, `solverJointStatistics`, `NO_RESOURCE_LEAKS`, `auditResourceLeaks`, `COORDINATE_ENVELOPE`, `NEAR_ZERO_SCALE`, `UNSTABLE_SCALE_RATIO`, `assertFinite`, `assertNoSceneGraphCycle`, `validateSceneNode`, `validateSceneSubtree`, `warnCoordinateEnvelope`, `warnSingularScale`, `warnUnstableScale`, `DEFAULT_PER_FRAME_ALLOCATION_THRESHOLD`, `beginFrameAllocationCheck`, `endFrameAllocationCheck`, `warnDetachedNodeListeners`, `warnDisposedResourceInUse`, `warnPerFrameAllocations`, `warnStalePhysicsHandle`, `copyFrameStats`, `createFrameStats`, `createMonotonicClock`, `monotonicNowSeconds`, `recordRenderStatistics`, `recordResourceMemory`, `recordSolverStatistics`, `resetFrameStats`, `solverStatistics`, `Checksum`, `ReplayRecorderOptions`, `ReplaySnapshot`, `ReplayTarget`, `RollbackBufferOptions`, `RollbackTarget`, `JsonValue`, `ReplayAdapterIdentity`, `ReplayFrameRecord`, `ReplayInputRecord`, `ReplayRecording`, `ReplaySnapshotRecord`, `UntrustedJsonLimits`, `ReplayPlayerOptions`, `ReplayStepEvent`, `ReplayStepListener`, `CollectBodyOriginsOptions`, `CollectBodyVelocitiesOptions`, `CollectCentersOfMassOptions`, `CollectContactImpulsesOptions`, `CollectContactPointsOptions`, `DebugBodyAccess`, `DebugCenterOfMassAccess`, `DebugCollisionEventLike`, `DebugColor`, `DebugContactPoint`, `DebugDrawBufferOptions`, `DebugDrawStreams`, `DebugGeometrySink`, `DebugJointAccess`, `DebugPhysicsEventLike`, `SolverJointStatistics`, `SolverStatistics`, `StagedVisualization`, `Vector3Like`, `AuditResourceLeaksOptions`, `LiveResourceCounts`, `ResourceLeakReport`, `ValidationCatalogueOptions`, `ValidationCheckOptions`, `ValidationNodeLike`, `ValidationTransformLike`, `ClockSource`, `FrameStats`, `RenderStatisticsLike`
...
- Functions: `warnCoordinateEnvelope`, `warnSingularScale`, `warnUnstableScale`, `assertFinite`, `assertNoSceneGraphCycle`, `validateSceneNode`, `validateSceneSubtree`
...
|------|--------------|------------|
| `packages/render/src/index` | 26 files | 0 files |
...
| `packages/physics/src/index` | 21 files | 0 files |
| `packages/physics/src/world` | 13 files | 6 files |
| `packages/motion/src/index` | 19 files | 0 files |
...
| `packages/materials/src/index` | 11 files | 0 files |
| `packages/math/src/index` | 10 files | 0 files |
| `packages/diagnostics/src/index` | 10 files | 0 files |
...
| `packages/render/src/render-list` | 5 files | 4 files |
...
| `packages/math/src/alloc-counter` | 0 files | 8 files |
| `packages/render/src/render-target` | 1 file | 7 files |
...
graph TD
    ...
    subgraph Packages/render-webgl
        N42[gl-batch]
        N43[gl-texture]
        N44[gl-skinning-registry]
        N45[index]
        N46[gl-render-target]
        N47[gl-picking-registry]
        N48[gl-effect]
        N49[gl-geometry]
        N50[gl-skinning]
        N51[gl-picking]
    ...
    subgraph Packages/four
        ...
        N87[render-webgl]
        N88[text-node]
        N89[manifest-catalog]
        N90[scene-serializers]
        N91[render-svg]
        N92[serialization]
        N93[...23 more]
    end
    ...
    subgraph Packages/physics
        ...
        N106[capabilities]
        N107[descriptors]
        N108[physics-event-system]
        N109[types]
        N110[swept-character-controller]
        N111[index]
        N112[material]
        N113[queries]
        N114[world]
    ...
    subgraph Packages/geometry
        N116[svg-path]
        N117[tessellation]
        N118[primitive-support]
        N119[path]
        N120[index]
        N121[resource-memory]
        N122[primitives]
        N123[buffer-geometry]
        N124[primitives-3d]
        N125[geometry]
    end
    ...
    subgraph Packages/materials
        N126[unlit-material]
        N127[node-material-builder]
        N128[stencil-state]
        N129[index]
        N130[material]
        N131[node-material]
        N132[standard-material]
        N133[resource-memory]
        N134[sprite-material]
        N135[shader-graph]
        N136[...2 more]
    end
    ...
    subgraph Packages/motion
        ...
        N182[capabilities]
        N183[steering]
        N184[kinematic-controller]
        N185[motion-component]
        N186[trajectories]
        N187[camera-rigs]
        N188[random]
        N189[...10 more]
    ...
    subgraph Packages/physics-rapier
        N190[rapier2d-adapter]
        N191[index]
        N192[conversions2d]
        N193[rapier3d-adapter]
        N194[conversions3d]
        N195[register]
        N196[init]
        N197[ccd]
...
| Total Modules | 24 |
| Total Lines of Code | 139009 |
| Total Exports | 2888 |
| Total Re-exports | 1844 |
| Total Classes | 182 |
| Total Interfaces | 543 |
| Total Functions | 460 |
| Total Type Guards | 23 |
| Total Enums | 0 |
| Type-only Imports | 359 |

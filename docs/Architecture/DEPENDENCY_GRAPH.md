...
**Version**: 0.0.0 | **Last Updated**: 2026-09-07
...
- **packages/render-webgpu**: 25 files
...
- Constants: `PARTICLE_GL`, `PARTICLE_ATTRIBUTE_LOCATIONS`, `PARTICLE_DEPTH_TEXTURE_UNIT`
...
| `./gl-particles.js` | `PARTICLE_ATTRIBUTE_LOCATIONS, PARTICLE_DEPTH_TEXTURE_UNIT, PARTICLE_GL, ParticleAppearanceProgram, ParticleBatchCache, ParticleProgram, ParticleTrailBatchCache, ParticleTrailProgram, particleItemFloats` | Re-export |
...
| `packages/render-webgpu/src/webgpu-device` | 0 files | 23 files |
| `packages/render-webgpu/src/webgpu-renderer` | 20 files | 2 files |
...
| `packages/animation/src/tween` | 3 files | 5 files |
| `packages/assets/src/index` | 8 files | 0 files |
...
graph TD
    ...
    subgraph Packages/materials
        ...
        N74[lit-material]
        N75[material]
        N76[node-material-builder]
        N77[node-material]
        N78[resource-memory]
        N79[shader-graph]
        N80[shader-operators]
        N81[sprite-material]
        N82[...4 more]
    end
    ...
    subgraph Packages/motion
        ...
        N95[camera-shake]
        N96[capabilities]
        N97[character-controller]
        N98[clock]
        N99[constraints]
        N100[ik]
        N101[index]
        N102[integrators]
        N103[kinematic-controller]
        N104[...12 more]
    end
    ...
    subgraph Packages/particles
        ...
        N106[fields]
        N107[index]
        N108[particle-renderable]
        N109[particle-system]
        N110[pool]
        N111[random]
        N112[trail]
        N113[types]
    ...
    subgraph Packages/physics-rapier
        ...
        N129[index]
        N130[init]
        N131[rapier2d-adapter]
        N132[rapier3d-adapter]
        N133[register]
    end
    ...
    subgraph Packages/render-webgl
        ...
        N150[gl-geometry]
        N151[gl-gpu-timer]
        N152[gl-node-program]
        N153[gl-particles]
        N154[gl-picking-registry]
        N155[gl-picking]
        N156[gl-program]
        N157[gl-render-target]
        N158[...9 more]
    end
...
| Category | Count |
|----------|-------|
| Total TypeScript Files | 313 |
| Total Modules | 24 |
| Total Lines of Code | 151078 |
| Total Exports | 3159 |
| Total Re-exports | 2018 |
| Total Classes | 194 |
| Total Interfaces | 590 |
| Total Functions | 514 |
| Total Type Guards | 26 |
| Total Enums | 0 |
| Type-only Imports | 399 |

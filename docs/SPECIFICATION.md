...
Shipped form (RFC 0005, accepted 2026-08-21; recorded revision 1.15): `hitTestMode`
...
- Playwright;
- Oxlint (type-aware; replaced ESLint with the TypeScript 7 move, revision 1.15);
- Prettier;
